...
public class MusicManager implements Disposable
{
	...
	public void play(BackgroundMusic music)
	{
		...
		// do some logging
		Gdx.app.log(TanksGame.LOG, "Playing music: " + music.getName());
	...
	public void stop()
	{
		...
		{
			Gdx.app.log(TanksGame.LOG, "Stopping current music");
	...
	{
		Gdx.app.log(TanksGame.LOG, "Adjusting music volume to: " + volume);
	...
	public void dispose()
	{
		Gdx.app.log(TanksGame.LOG, "Disposing music manager");
//		stop();
	}
}